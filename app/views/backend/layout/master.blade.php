  ...
  <body>
    ...
    <div role="tabpanel" class="sidepanel">
      ...
      <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class=""><a class="" aria-expanded="false" href="#today" aria-controls="today" role="tab" data-toggle="tab">TODAY</a></li>
        <li class="" role="presentation"><a aria-expanded="false" class="" href="#tasks" aria-controls="tasks" role="tab" data-toggle="tab">TASKS</a></li>
        <li class="active" role="presentation"><a aria-expanded="true" class="active" href="#chat" aria-controls="chat" role="tab" data-toggle="tab">CHAT</a></li>
      </ul>
      ...
      <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane active" id="chat">
          ...
          <form class="search">
            <input class="form-control" placeholder="Search a Friend..." type="text">
          </form>
        </div>
        <!-- End Chat -->
      </div>
